...
/// Минимальное время между созданием бизнесов (1 секунда для тестирования)
pub const BUSINESS_CREATE_COOLDOWN: i64 = 1; // 1 секунда

/// Минимальное время между клеймами заработка (1 секунда для тестирования)  
pub const CLAIM_EARNINGS_COOLDOWN: i64 = 1; // 1 секунда

/// Минимальное время между обновлениями заработка (1 секунда для тестирования)
pub const UPDATE_EARNINGS_COOLDOWN: i64 = 1; // 1 секунда
